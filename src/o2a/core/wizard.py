...
def run_init_wizard():
    print("Welcome to o2a Configuration Wizard!")
    print("This will verify your setup and create a ~/.config/o2a/config.toml file.")
    print("")
    ...
    config_content = f"""# o2a Configuration
# Generated by o2a init
...
"""
    ...
    target_path = Path.home() / ".config/o2a/config.toml"
    ...
    try:
        ...
        print("You can now run 'o2a <path>' without specifying media/vault flags.")
